...
fn_template="TiS2_l40_PAD_PW_%ddeg_%deV_Sqrt_l%d.dat"
...
for i, angle in enumerate(angles):
    ...
    with open(fn, "w") as f:
        ...
        f.write("Log_file TiS2_l40_PAD_PW_%ddeg_%deV_Sqrt_l%d.log\n" % (angle, hn, depth))
        f.write("Console_log true\n")
        f.write("Output_file TiS2_l40_PAD_PW_%ddeg_%deV_Sqrt_l%d.hdf5\n" % (angle, hn, depth))
        f.write("/\n")
        f.write("&PAD\n")
