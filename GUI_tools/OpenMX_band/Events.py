                    ...
                    if LCAO_label==LCAO_label_ref:
                        ...
                        for s in range(0, numSpin):
                            ...
                            if orbitLabel=="s":
                                ...
                                item1=QtWidgets.QTableWidgetItem(("s ({0:.2f}, {1:.2f})").format(LCAO_disp[0][0+s2], LCAO_disp[0][1+s2]))
                                win.LCAOTable.setItem(currentRow-1, 0+s2, item1)
                                item2=QtWidgets.QTableWidgetItem(("s ({0:.2f}, {1:.2f})").format(LCAO_disp[0][0+s2], LCAO_disp[0][1+s2]))
                            ...
                            if orbitLabel=="p":
                                ...
                                # table
                                item1=QtWidgets.QTableWidgetItem(("px ({0:.2f}, {1:.2f})").format(LCAO_disp[0][0+s2], LCAO_disp[0][1+s2]))
                                item2=QtWidgets.QTableWidgetItem(("py ({0:.2f}, {1:.2f})").format(LCAO_disp[1][0+s2], LCAO_disp[1][1+s2]))
                                item3=QtWidgets.QTableWidgetItem(("pz ({0:.2f}, {1:.2f})").format(LCAO_disp[2][0+s2], LCAO_disp[2][1+s2]))
                                ...
                                item1=QtWidgets.QTableWidgetItem(("p(-1) ({0:.2f}, {1:.2f})").format(pm1.real, pm1.imag))
                                item2=QtWidgets.QTableWidgetItem(("p(+0) ({0:.2f}, {1:.2f})").format(pp0.real, pp0.imag))
                                item3=QtWidgets.QTableWidgetItem(("p(+1) ({0:.2f}, {1:.2f})").format(pp1.real, pp1.imag))
                            ...
                            if orbitLabel=="d":
                                ...
                                # table
                                item1=QtWidgets.QTableWidgetItem(("d3z2r2 ({0:.2f}, {1:.2f})").format(LCAO_disp[0][0+s2], LCAO_disp[0][1+s2]))
                                item2=QtWidgets.QTableWidgetItem(("dx2y2  ({0:.2f}, {1:.2f})").format(LCAO_disp[1][0+s2], LCAO_disp[1][1+s2]))
                                item3=QtWidgets.QTableWidgetItem(("dxy    ({0:.2f}, {1:.2f})").format(LCAO_disp[2][0+s2], LCAO_disp[2][1+s2]))
                                item4=QtWidgets.QTableWidgetItem(("dxz    ({0:.2f}, {1:.2f})").format(LCAO_disp[3][0+s2], LCAO_disp[3][1+s2]))
                                item5=QtWidgets.QTableWidgetItem(("dyz    ({0:.2f}, {1:.2f})").format(LCAO_disp[4][0+s2], LCAO_disp[4][1+s2]))
                                ...
                                item1=QtWidgets.QTableWidgetItem(("d(-2) ({0:.2f}, {1:.2f})").format(dm2.real, dm2.imag))
                                item2=QtWidgets.QTableWidgetItem(("d(-1) ({0:.2f}, {1:.2f})").format(dm1.real, dm1.imag))
                                item3=QtWidgets.QTableWidgetItem(("d(+0) ({0:.2f}, {1:.2f})").format(dp0.real, dp0.imag))
                                item4=QtWidgets.QTableWidgetItem(("d(+1) ({0:.2f}, {1:.2f})").format(dp1.real, dp1.imag))
                                item5=QtWidgets.QTableWidgetItem(("d(+2) ({0:.2f}, {1:.2f})").format(dp2.real, dp2.imag))
                            ...
                            if orbitLabel=="f":
                                ...
                                # table
                                item1=QtWidgets.QTableWidgetItem(("f5z23r2  ({0:.2f}, {1:.2f})").format(LCAO_disp[0][0+s2], LCAO_disp[0][1+s2]))
                                item2=QtWidgets.QTableWidgetItem(("f5xy2xr2 ({0:.2f}, {1:.2f})").format(LCAO_disp[1][0+s2], LCAO_disp[1][1+s2]))
                                item3=QtWidgets.QTableWidgetItem(("f5yz2yr2 ({0:.2f}, {1:.2f})").format(LCAO_disp[2][0+s2], LCAO_disp[2][1+s2]))
                                item4=QtWidgets.QTableWidgetItem(("fzx2zy2  ({0:.2f}, {1:.2f})").format(LCAO_disp[3][0+s2], LCAO_disp[3][1+s2]))
                                item5=QtWidgets.QTableWidgetItem(("fxyz     ({0:.2f}, {1:.2f})").format(LCAO_disp[4][0+s2], LCAO_disp[4][1+s2]))
                                item6=QtWidgets.QTableWidgetItem(("fx33xy2  ({0:.2f}, {1:.2f})").format(LCAO_disp[5][0+s2], LCAO_disp[5][1+s2]))
                                item7=QtWidgets.QTableWidgetItem(("f3yx2y3  ({0:.2f}, {1:.2f})").format(LCAO_disp[6][0+s2], LCAO_disp[6][1+s2]))
                                ...
                                item1=QtWidgets.QTableWidgetItem(("f(-3) ({0:.2f}, {1:.2f})").format(fm3.real, fm3.imag))
                                item2=QtWidgets.QTableWidgetItem(("f(-2) ({0:.2f}, {1:.2f})").format(fm2.real, fm2.imag))
                                item3=QtWidgets.QTableWidgetItem(("f(-1) ({0:.2f}, {1:.2f})").format(fm1.real, fm1.imag))
                                item4=QtWidgets.QTableWidgetItem(("f(+0) ({0:.2f}, {1:.2f})").format(fp0.real, fp0.imag))
                                item5=QtWidgets.QTableWidgetItem(("f(+1) ({0:.2f}, {1:.2f})").format(fp1.real, fp1.imag))
                                item6=QtWidgets.QTableWidgetItem(("f(+2) ({0:.2f}, {1:.2f})").format(fp2.real, fp2.imag))
                                item7=QtWidgets.QTableWidgetItem(("f(+3) ({0:.2f}, {1:.2f})").format(fp3.real, fp3.imag))
