...
void solve_final_state(double Ekin, double* k_para, double kz, int g_count, int z_count, double dz, double z_bottom, int V00_index, complex<double>** Vgg_buffer, double* g_vec_buffer, complex<double>* FP_loc_buffer){
